...
<form action="huanzheServlet" method="post">
    ...
    <div>
        ...
        <table>
            ...
            <tr>
                <th>年龄</th>
                <td><input type="number" min="1" max="100" value="18" name="age">
                	<select name="ageType">
        ...
        <table>
            ...
            <tr>
                <th>挂号科室</th>
                <td>
                    <select name="deptmentId" id="deptmentId">
						<option>--请选择--</option>
					...
					<td>
					<div class="col-md-2">
						<select  class="form-control"  name="registLevelId" id="registLevelId" onchange="getDoctor(this)">
				...
				<div>
					<div class="col-md-2">
						<select  class="form-control" name="employeeId" id="employeeId" onchange="doctorChanged(this)">
							<option>--请选择--</option>
						<!-- 	<option value="1">扁鹊</option>
							<option value="2">范无病</option>
							<option value="3">皇甫谧</option> -->
						</select>					
					</div>			
				</div>
				</td>
					...
					<th>
						<label for="endtime" class="col-md-1 control-label mt-2  text-right">已用号额</label>
					</th>
					<td>
						<div class="col-md-2">
					...
					<td>
					<div class="col-md-2">
						<!-- <input type="checkbox" class="form-check-input" name="isBook">	 -->
						<input type="radio" name="isBook" value="是"/>是
						<input type="radio" name="isBook" value="否"/>否
					</div>
...
/* 	request.setCharacterEncoding("utf-8");
   ...
   /*  btnRegister.addEventListener('click', function() {
    ...
    function doctorChanged(thisSelect){
    	let employeeId=thisSelect.value;//获取选择的值
		console.log("selectedemployeeId="+employeeId);
		$.getJSON("${pageContext.request.contextPath}/UserDo?method=registerCount",
				{"employeeId":employeeId},function(res){
				console.log(res);
				$('#usedQuota').val(res.registeredCount);//已经挂该医生的患者数
